...
public class Weapon : MonoBehaviour
{
    ...
    // Recoil
    public bool recoil = false;                         // Whether or not this weapon should have recoil
    ...
    void Update()
    {
        if (Input.GetKeyDown("return") && !gameStart && this.tag == "StartWeapon")
        {
            playerWeapon = true;
            showCrosshair = true;
            showCurrentAmmo = true;
            ...
            enemyTimer += 1;
        {
            ...
            if (enemyTimer > 800 && playerInRange)
            {
                ...
                if (hitChance > 5 && type != WeaponType.Projectile)
                {
